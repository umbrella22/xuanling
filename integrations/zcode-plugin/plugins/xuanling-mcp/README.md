...
The released `xuanling-mcp` 0.4.0 plugin is a self-contained ZCode integration.
...
no request-policy hook. XuanLing 0.4.0 is not publisher-signed; npm provenance, the
