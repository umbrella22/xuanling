...
The released `xuanling-mcp` 0.3.2 plugin is a self-contained ZCode integration.
...
no request-policy hook. XuanLing 0.3.2 is not publisher-signed; npm provenance, the
