...
The Memory bundle installs the exact `@xuanling-rs/xuanling-mcp@0.2.7` launcher and native
...
| --- | --- | --- |
| MCP runtime | Profile-local `@xuanling-rs/xuanling-mcp@0.2.7` | Verified JS launcher and native optional dependency |
