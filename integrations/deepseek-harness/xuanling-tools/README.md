...
```sh
dsh plugin --profile web add @xuanling-rs/xuanling-dsh-tools@0.2.6
```
...
The exact `@xuanling-rs/xuanling-mcp@0.2.6` runtime is installed in the profile and started
