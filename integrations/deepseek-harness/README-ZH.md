...
Memory bundle 会在 profile 内安装精确版本的 `@xuanling-rs/xuanling-mcp@0.2.8` launcher 和原生 optional
...
| 设置 | 默认值 | 作用 |
| --- | --- | --- |
| MCP runtime | Profile 内的 `@xuanling-rs/xuanling-mcp@0.2.8` | 经过校验的 JS launcher 与原生 optional dependency |
