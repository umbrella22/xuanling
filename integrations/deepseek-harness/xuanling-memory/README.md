...
The server opens `~/.xuanling/memory.db` lazily on the first valid Memory call;
startup, catalog discovery, and malformed Memory input do not create or migrate
the database.
