...
```sh
dsh plugin --profile web add @xuanling-rs/xuanling-dsh-memory@0.2.7
```
...
The bundle installs `@xuanling-rs/xuanling-mcp@0.2.7` inside the selected profile. Its
...
Use `@xuanling-rs/xuanling-dsh-skills@0.2.7` alongside this bundle for the proposal-first
