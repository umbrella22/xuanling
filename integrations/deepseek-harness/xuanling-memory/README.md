...
```sh
dsh plugin --profile web add @xuanling-rs/xuanling-dsh-memory@0.2.8
```
...
The bundle installs `@xuanling-rs/xuanling-mcp@0.2.8` inside the selected profile. Its
...
Use `@xuanling-rs/xuanling-dsh-skills@0.2.8` alongside this bundle for the proposal-first
