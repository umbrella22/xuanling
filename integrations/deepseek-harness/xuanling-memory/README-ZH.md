...
Bundle 会在所选 profile 内安装 `@xuanling-rs/xuanling-mcp@0.2.5`，并从该 profile 解析 schema adapter
...
可以同时安装 `@xuanling-rs/xuanling-dsh-skills@0.2.5`，获得 proposal-first Memory 工作流和严格整文件
