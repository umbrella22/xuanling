...
```sh
dsh plugin --profile web add @xuanling-rs/xuanling-dsh-tools-replace@0.2.8
```
...
The exact `@xuanling-rs/xuanling-mcp@0.2.8` runtime is installed in the profile and started
