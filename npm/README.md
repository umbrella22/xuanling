...
XuanLing MCP 0.2.7. A complete release contains eight immutable npm items: one
...
| --- | --- | --- |
| `@xuanling-rs/xuanling-mcp` | `0.2.7` | Stable Node.js launcher |
| `@xuanling-rs/xuanling-mcp-darwin-arm64` | `0.2.7-darwin-arm64` | macOS Apple Silicon |
| `@xuanling-rs/xuanling-mcp-linux-x64-gnu` | `0.2.7-linux-x64-gnu` | Linux x64, glibc 2.35 or newer |
| `@xuanling-rs/xuanling-mcp-win32-x64-msvc` | `0.2.7-win32-x64-msvc` | Windows x64 MSVC |
...
| Package | Purpose |
| --- | --- |
| `@xuanling-rs/xuanling-dsh-memory@0.2.7` | Complete Memory v2 profile with DSH schema projection |
| `@xuanling-rs/xuanling-dsh-skills@0.2.7` | File and Memory workflow Skills plus strict overwrite policy |
| `@xuanling-rs/xuanling-dsh-tools@0.2.7` | Additive full XuanLing catalog |
| `@xuanling-rs/xuanling-dsh-tools-replace@0.2.7` | Full catalog with model-facing native filesystem rows disabled |
...
- XuanLing 0.2.7 does not claim a Developer ID or Authenticode publisher
